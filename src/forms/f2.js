  ...
  return (
    ...
    <div >
      ...
      <tr >    
          ...
          <td ><input type="radio" name='(a) bars you from association with an entity regulated by such commission, authority, agency, or officer, or from activities, or credit union activities; or' value="YES"/></td>
          <td ><input type="radio" name='(a) bars you from association with an entity regulated by such commission, authority, agency, or officer, or from activities, or credit union activities; or' value="NO"/></td>
          </tr>
      <tr >
      <td className='sub2'>
      ...
      <td ><input type="radio" name='(b) constitutes a final order based on violations of any laws or regulations that prohibit fraudulent, manipulative, or deceptive conduct?' value="YES" /></td>
          <td ><input type="radio" name='(b) constitutes a final order based on violations of any laws or regulations that prohibit fraudulent, manipulative, or deceptive conduct?' value="NO"/></td>      
      </tr>
      ...
      <td ><input type="radio" name='(1) found you to have ade a false statement or omission?' value="YES" /></td>
      <td ><input type="radio" name='(1) found you to have ade a false statement or omission?' value="NO"/></td>
      </tr>
      <tr>
          ...
          <td ><input type="radio" name='(2) found you to have been involved in a violation of its rules (other than a violation designated as a "minor rule violation" under a plan approved by the U.S. Securities and Exchange Commission)?' value="YES" /></td>
      <td ><input type="radio" name='(2) found you to have been involved in a violation of its rules (other than a violation designated as a "minor rule violation" under a plan approved by the U.S. Securities and Exchange Commission)?' value="NO"/></td>
      </tr>
      <tr>
          ...
          <td ><input type="radio" name='(3) found you to have been the case of an investment-related business having its authorization to do business denied, suspended, revoked or restricted?' value="YES" /></td>
      <td ><input type="radio" name='(3) found you to have been the case of an investment-related business having its authorization to do business denied, suspended, revoked or restricted?' value="NO"/></td>
      </tr>
      <tr>
          ...
          <td ><input type="radio" name='(4) disciplined you by expelling or suspending you from membership, baning or suspending your association with its members, or restricting your activities' value="YES" /></td>
      <td ><input type="radio" name='(4) disciplined you by expelling or suspending you from membership, baning or suspending your association with its members, or restricting your activities' value="NO"/></td>
      </tr>
      <tr>
      ...
      <td ><input type="radio" name='(5) found you to have willfully violated any provision of the Securities Act of 1933, the Securities Exchange Act of 1934, the Investment Advisers Act of 1940, the Investment Company Act 1940, the Commodity Exchanege Act, or any rule or regulation under any of such Acts, or any of the rules of the Municipal Securities Rulemaking Board, or found you to have been unable to comply with any provision of such Act, rule or regulation?' value="YES" /></td>
      <td ><input type="radio" name='(5) found you to have willfully violated any provision of the Securities Act of 1933, the Securities Exchange Act of 1934, the Investment Advisers Act of 1940, the Investment Company Act 1940, the Commodity Exchanege Act, or any rule or regulation under any of such Acts, or any of the rules of the Municipal Securities Rulemaking Board, or found you to have been unable to comply with any provision of such Act, rule or regulation?' value="NO"/></td>
      </tr>
      <tr>
      ...
      <td ><input type="radio" name='(6) found you to have willfully aided, abetted, counseled, commanded, induced, or procured the violation by any person of any provision of the Securities Act of 1933, the Investment COmpany Act of 1940, the Commodity Exchange Act, or any rule or regulation under any of such Acts, or any of the rules of the Municipal Securities Rulemaking BOard?' value="YES" /></td>
  <td ><input type="radio" name='(6) found you to have willfully aided, abetted, counseled, commanded, induced, or procured the violation by any person of any provision of the Securities Act of 1933, the Investment COmpany Act of 1940, the Commodity Exchange Act, or any rule or regulation under any of such Acts, or any of the rules of the Municipal Securities Rulemaking BOard?' value="NO"/></td>
  </tr>
      <tr>
      ...
      <tr className='heading2' >
            ...
            <td ><input type="radio" name='14F. Have you ever had an authorization to act as an attorney, accountant or federal contractor that was revoked or suspended?' value="YES"/></td>
         <td ><input type="radio" name='14F. Have you ever had an authorization to act as an attorney, accountant or federal contractor that was revoked or suspended?' value="NO"/></td> 
        </tr>
        <tr className='heading2' >
    ...
    <td ><input type="radio" name='(1) regulatory complaint or proceeding that could result in a "yes" answer to any part of 14C, D or E? (If "yes", complete the Regulatory Action Disclosure Reporting Page.)' value="YES" /></td>
    <td ><input type="radio" name='(1) regulatory complaint or proceeding that could result in a "yes" answer to any part of 14C, D or E? (If "yes", complete the Regulatory Action Disclosure Reporting Page.)' value="NO"/></td>
    </tr>
    <tr>
    ...
    <td ><input type="radio" name='(2) Investigation that could result in a "yes" answer to any part of 14A, B, C, D or E? (if "yes", complete the Investigation Disclosure Reporting Page.)' value="YES" /></td>
     <td ><input type="radio" name='(2) Investigation that could result in a "yes" answer to any part of 14A, B, C, D or E? (if "yes", complete the Investigation Disclosure Reporting Page.)' value="NO"/></td>
    </tr>
    <tr className='heading'>
      ...
      <td ><input type="radio" name='(c) dismissed, pursuant to a settlement agreement, an investment-related civil action brought against you by a state or foreign financial regulatory authority?' value="NO" /></td> 
      </tr>
      <tr >
            ...
            <td ><input type="radio" name='(2) Are you named in any pending investment-related civil action that could result in a "yes" answer to any part of 14H(1)' value="YES"/></td>
         <td ><input type="radio" name='(2) Are you named in any pending investment-related civil action that could result in a "yes" answer to any part of 14H(1)' value="NO"/></td> 
        </tr>
      ...
      <tr>
          ...
          <td ><input type="radio" name='(a) is still pending, or;' value="YES" /></td>
       <td ><input type="radio" name='(a) is still pending, or;' value="NO" /></td> 
      </tr>
      <tr>
          <td className='sub2'>(b) resulted in an arbitration award or civil judgement against you, regardless of amount, or;</td>
          <td ><input type="radio" name='(b) resulted in an arbitration award or civil judgement against you, regardless of amount, or;' value="YES" /></td>
       <td ><input type="radio" name='(b) resulted in an arbitration award or civil judgement against you, regardless of amount, or;' value="NO"/></td>   
      </tr>
      <tr>
          <td className='sub2'>(c) was settled, prior to 02/18/2009, for an amount of $10,000 or more, or;</td>
          <td ><input type="radio" name='(c) was settled, prior to 02/18/2009, for an amount of $10,000 or more, or;' value="YES" /></td>
       <td ><input type="radio" name='(c) was settled, prior to 02/18/2009, for an amount of $10,000 or more, or;' value="NO"/></td> 
      </tr>
      <tr>
          <td className='sub2'>(d) was settled, on or after 05/18/2009, for an amount of $15,000 or more?</td>
          <td ><input type="radio" name='(d) was settled, on or after 05/18/2009, for an amount of $15,000 or more?' value="YES" /></td>
       <td ><input type="radio" name='(d) was settled, on or after 05/18/2009, for an amount of $15,000 or more?' value="NO"/></td> 
      </tr>
      </div>
      </table>
    </div>
